...
PDF_TEMPLATES: dict[str, PDFTemplateConfig] = {
    ...
    "Compact Tech CV": PDFTemplateConfig(
        name="Compact Tech CV",
        description="Dense one-to-two page technical layout with tight spacing and clear section dividers.",
        font_regular="Helvetica",
        font_bold="Helvetica-Bold",
        h1_size=19,
        h2_size=10.8,
        body_size=8.9,
        bullet_size=8.8,
        leading_multiplier=1.18,
        title_alignment=TA_LEFT,
        left_margin=0.55 * inch,
        right_margin=0.55 * inch,
        top_margin=0.48 * inch,
        bottom_margin=0.48 * inch,
        primary_color=colors.HexColor("#243B53"),
        section_line=True,
        section_uppercase=True,
        compact=True,
    ),
    "Clean European CV": PDFTemplateConfig(
        name="Clean European CV",
        description="Balanced clean layout with comfortable margins for European-style CVs.",
        font_regular="Helvetica",
        font_bold="Helvetica-Bold",
        h1_size=20,
        h2_size=12.2,
    ...
    "Research CV": PDFTemplateConfig(
        name="Research CV",
        description="Research-oriented layout for projects, methods, publications, education, and evidence-heavy sections.",
        font_regular="Times-Roman",
        font_bold="Times-Bold",
        h1_size=20,
        h2_size=12.2,
        ...
        primary_color=colors.HexColor("#3A3A3A"),
        section_line=True,
        section_uppercase=False,
        compact=False,
    ),
